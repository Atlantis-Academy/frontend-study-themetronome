document.addEventListener('DOMContentLoaded', () => {
  ...
  modalWindow.addEventListener('click', (e: Event) => (e.target === modalWindow ? closeModalWindow() : null));

  document.addEventListener('keydown', (e: KeyboardEvent) => (e.code === 'Escape' && modalWindow.classList.contains('show')
    ? closeModalWindow()
    : null));
});
